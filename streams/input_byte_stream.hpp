...
class input_byte_stream : public input_stream<byte>
{
    ...
    public:
                            input_byte_stream(data_provider_type& data_provider);
...
template <typename D>
inline input_byte_stream<D>::input_byte_stream(data_provider_type& data_provider)
                           : my_data_provider(data_provider)
{
}

template <typename D>
bool input_byte_stream<D>::eos() const
{
